  ...
  render() {
    ...
    return (
      <div className="search-bar">
        ...
        <input type="search" id="search-bar" autoComplete="false" autoCorrect="false" value={this.state.textInput} onChange={this.searchAlbum} placeholder="Comece a escrever..."/>
      </div>
    )
